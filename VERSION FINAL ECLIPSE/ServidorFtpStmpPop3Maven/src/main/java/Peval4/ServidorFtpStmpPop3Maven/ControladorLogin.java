...
public class ControladorLogin {
					...
					if(url.endsWith("login.html")) {
						...
						bajarFichero.addEventListener(DOMEventType.OnClick, new DOMEventListener() {
							public void handleEvent(DOMEvent event) {
								...
								File file = new File(
									ControladorLogin.class.getResource("Disenio/Html/descargaArchivo.html").getFile()
								);
								browser.loadURL(file.toString());
							}
						}, false);
	...
	public class getDatosCorreo {
		...
		/**
		 * @param b variable de tipo Browser que nos permitira acceder al
		 * javascript del html para hacer uso del local storage y recuperar los
